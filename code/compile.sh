...
gcc -c simulation.c
gcc simulation.o servicenode1alg.o servicenode2alg.o servicenode3alg.o servicenode4alg.o servicenode5alg.o rngs.o randomGeneratorFunctions.o -o simulation -lm
